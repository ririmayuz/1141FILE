            ...
            <tr>
                ...
                <td>
                    ...
                    if ($row['type'] == 'image') {
                        ...
                        switch ($row['type']) {
                            case 'document':
                                echo "<img src='icon/document.png' style='width:64px;'>";
                                break;
                            case 'video':
                                echo "<img src='icon/video.png' style='width:64px;'>";
                                break;
                            case 'music':
                                echo "<img src='icon/music.png' style='width:64px;'>";
                                break;
                            default:
                                echo "<img src='icon/others.png' style='width:64px;'>";
                                break;
                        }
                    }
